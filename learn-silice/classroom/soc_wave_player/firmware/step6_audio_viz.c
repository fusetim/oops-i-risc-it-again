...
void main()
{
  ...
  if (f == NULL) {
    ...
    unsigned int cc = rdcycle()>> 7; 
    unsigned int avgs[8] = {0};
    ...
    while (1) {
      ...
      while (addr == (int*)(*AUDIO)) { }
      // light show!
      if (cc & 0b01 > 0) avgs[0] = 0;
      if (cc & 0b10 > 0) avgs[1] = 0;
      if (cc & 0b100 > 0) avgs[2] = 0;
      if (cc & 0b1000 > 0) avgs[3] = 0;
      if (cc & 0b10000 > 0) avgs[4] = 0;
      if (cc & 0b100000 > 0) avgs[5] = 0;
      if (cc & 0b1000000 > 0) avgs[6] = 0;
      if (cc & 0b10000000 > 0) avgs[7] = 0;
